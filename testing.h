...
void test_2D(const std::string &mesh_file,
             ...
             const std::vector<Quadrangle> &quadrangles)
{
  // read the mesh
  Mesh mesh;
  EXPECT_NO_THROW(mesh.read(mesh_file));
...
void test_3D(const std::string &mesh_file,
             std::vector<Point> &vertices,
             const std::vector<Point> &new_vertices,
             const std::vector<Line> &edges,
             const std::vector<Line> &lines,
...
std::string mesh_2d_1();
std::string mesh_2d_2();
std::string mesh_3d_1();
std::string mesh_3d_2();
...
{
  std::string mesh_file = mesh_2d_1();
...
{
  std::string mesh_file = mesh_2d_2();
...
{
  std::string mesh_file = mesh_3d_1();
...
{
  std::string mesh_file = mesh_3d_2();
...
std::string mesh_2d_1()
{
  std::string mesh_file = "mesh_2d_1.msh";
  std::ofstream out(mesh_file.c_str());
  require(out, "File " + mesh_file + " cannot be opened!");
  out << "$MeshFormat\n2.2 0 8\n$EndMeshFormat\n$Nodes\n";
  out << "3\n";
  out << "1 0 0 0\n";
  out << "2 1 0 0\n";
...
std::string mesh_2d_2()
{
  std::string mesh_file = "mesh_2d_2.msh";
  std::ofstream out(mesh_file.c_str());
  require(out, "File " + mesh_file + " cannot be opened!");
  out << "$MeshFormat\n2.2 0 8\n$EndMeshFormat\n$Nodes\n";
  out << "4\n";
...
std::string mesh_3d_1()
{
  std::string mesh_file = "mesh_3d_1.msh";
  std::ofstream out(mesh_file.c_str());
  require(out, "File " + mesh_file + " cannot be opened!");
  out << "$MeshFormat\n2.2 0 8\n$EndMeshFormat\n$Nodes\n";
  out << "4\n";
...
std::string mesh_3d_2()
{
  std::string mesh_file = "mesh_3d_2.msh";
  std::ofstream out(mesh_file.c_str());
  require(out, "File " + mesh_file + " cannot be opened!");
  out << "$MeshFormat\n2.2 0 8\n$EndMeshFormat\n$Nodes\n";
  out << "5\n";
